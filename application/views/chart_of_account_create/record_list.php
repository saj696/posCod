...
//                {name: 'parent_account', type: 'string'},
        ...
        $("#load_grid").jqxGrid({
            ...
            autoheight: true,
            columns: [
                {text: 'Chart of account Name', dataField: 'account_name',filtertype: 'none'},
                {text: 'Account code', dataField: 'account_code',filtertype: 'none'},
//                    {text: 'Parent Account', dataField: 'parent_account'},
                {text: 'Account Type', dataField: 'account_type',filtertype: 'checkedlist'},
