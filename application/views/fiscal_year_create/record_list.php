...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            [
                {name: 'id', type: 'int'},
                {name: 'fiscal_year_code', type: 'string'},
        ...
        $("#load_grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {text: 'Fiscal Year Code', dataField: 'fiscal_year_code'},
                    {text: 'Start Date', dataField: 'start_date'},
                    {text: 'End Date', dataField: 'end_date'},
                    {text: 'Status', dataField: 'status'},
                    {
                        text: '<?php echo $this->lang->line('DELETE')?>', datafield: 'Delete', columntype: 'button', cellsrenderer: function ()
                    {
                    ...
                    {
                        text: '<?php echo $this->lang->line('EDIT')?>', datafield: 'Edit', columntype: 'button', cellsrenderer: function ()
                    {
