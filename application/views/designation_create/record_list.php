        ...
        $("#load_grid").jqxGrid(
            {
                ...
                autoheight: true,
                columns: [
                    {text: 'Designation Name', dataField: 'name_en',filtertype: 'checkedlist'},
                    {text: 'Ordering', dataField: 'ordering',filtertype: 'checkedlist'},
                    ...
                    { text: '<?php echo $this->lang->line('EDIT')?>', datafield: 'Edit', columntype: 'button',filtertype: 'none', cellsrenderer: function () {
