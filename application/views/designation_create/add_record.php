            ...
            <div class="portlet-body">
                <form class="form-horizontal" action="<?php echo base_url().$controller_name.'/'.$add_record;?>" method="post" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="name_en" placeholder="<?php echo $this->lang->line('NAME');?>" class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="name_bn" placeholder="<?php echo $this->lang->line('NAME_BN');?>" class="form-control">
                        </div>
                        <span class="star_required">*</span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="number" min="0" name="ordering" placeholder="<?php echo $this->lang->line('ORDERING');?>" class="form-control">
                        </div>
                        <span class="star_required">*</span>
                    </div>
                    <div class="form-group">
