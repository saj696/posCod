...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        $("#load_grid").jqxGrid(
        {
            ...
            autoheight: true,
            columns: [
                {text: 'Transaction id', dataField: 'id',filtertype: '', width:'10%'},
                {text: 'Supplier Name', dataField: 'username',filtertype: 'checkedlist'},
                {text: 'Total Amount', dataField: 'total_amount',filtertype: 'checkedlist'},
                {text: 'Purchase Date', dataField: 'date',filtertype: 'checkedlist'},
                ...
                {text: '<?php echo $this->lang->line('TRANSPORT')?>', datafield: 'Transport',filtertype: 'none', columntype: 'button', cellsrenderer: function (){
                    return "<?php echo $this->lang->line('TRANSPORT')?>";
                },
                    ...
                    buttonclick: function (row)
                    {
                        // open the popup window when the user clicks a button.
                        id = $("#load_grid").jqxGrid('getrowid', row);
                        window.location = "<?php echo base_url().$this->controller_name.'/'.'set_transport_cost'; ?>/"+id;
                    }
                }
