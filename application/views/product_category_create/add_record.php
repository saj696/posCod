            ...
            <div class="portlet-body">
                <form class="form-horizontal" action="<?php echo base_url().$controller_name.'/'.$add_record;?>" method="post" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="category_name" value="<?php echo $record_info['category_name'];?>" placeholder="<?php echo $this->lang->line('NAME');?>" class="form-control">
                        </div>
                        <span class="star_required">*</span>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php echo $this->lang->line('PARENT');?>:</label>
                        <div class="col-md-3">
                            <select class="form-control input-medium" name="parent_id">
                                <?php
                                $this->load->view('dropdown', array('drop_down_options'=>$parent_list, 'drop_down_selected'=>$record_info['parent_id']));
                                ?>
                            </select>
                        </div>
                    </div>
