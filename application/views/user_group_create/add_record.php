            ...
            <div class="portlet-body">
                <form class="form-horizontal" action="<?php echo base_url().$controller_name.'/'.$add_record;?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="title" value="<?php echo $record_info['title'];?>" placeholder="<?php echo $this->lang->line('NAME');?>" class="form-control" >
                        </div>
                        <span class="star_required">*</span>
                    </div>
                    <div class="form-group">
                        <label for="title" class="col-md-3 control-label"><?php echo $this->lang->line('ORDER');?>:</label>
                        <div class="col-md-7">
                            <input type="number" min="0" name="ordering" value="<?php echo $record_info['ordering'];?>" placeholder="<?php echo $this->lang->line('ORDER');?>" class="form-control" >
                        </div>
                        <span class="star_required">*</span>
                    </div>
                    <div class="form-group">
