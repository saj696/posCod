...
class User_create extends Root_Controller
{
    ...
    function __construct()
    {
        ...
        $this->model_name = "user_create_model";
    ...
    public function record_list()
    {
        ...
        $data['new_button_name']=$this->lang->line('USER_CREATE');
        $this->template->load('admin_default_template', 'user_create/record_list',$data);
    }
    ...
    public function add_record()
    {
        ...
        if($this->input->post())
        {
            if(!$this->check_validation())
            {
                ...
                $data['counters'] = Query_helper::get_list($this->config->item('table_counters'),'counter_name',array('status = '.$this->config->item('STATUS_ACTIVE')));
                $this->template->load('admin_default_template', 'user_create/add_record', $data);
            }
            else
            {
                ...
                $record_data['user_type'] = $input_data['user_type'];
                $record_data['counter_id'] = $input_data['counter_id'];
                $record_data['data_access'] = $input_data['data_access'];
    ...
    private function check_validation($record_id='')
    {
        ...
        if($this->input->post('user_type')==$this->config->item('USER_TYPE_COUNTER'))
        {
            $this->form_validation->set_rules('counter_id',$this->lang->line('COUNTER_NAME'),'required');
        }
        $this->form_validation->set_rules('user_type',$this->lang->line('USER_TYPE'),'required');
        $this->form_validation->set_rules('data_access',$this->lang->line('USER_DATA_ACCESS'),'required');
