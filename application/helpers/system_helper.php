...
class System_helper
{
    ...
    public static function get_sql_date($date_format)
    {
    ...
    // This function return id of active fiscal year
    // Created by : ANTU ROZARIO

    public static function get_active_fiscal_year(){
        $CI =& get_instance();
        $CI->db->select('id');
        $CI->db->from($CI->config->item('table_fiscal_year'));
